...
//@interface udptestObject : NSObject
//@end

@interface udptestObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[udptestObject class]])
		{
			for (NSString *key in [[(udptestObject*)o modules] allKeys])
			{
